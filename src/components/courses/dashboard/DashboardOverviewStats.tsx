import { BarChart2, BookOpen, Clock, Trophy } from "lucide-react";

import Card from "@/components/ui/Card";
import type { OverviewModalType } from "@/types/courses-dashboard-type";
...
interface DashboardOverviewStatsProps {
  ...
  onOpenOverview: (type: OverviewModalType) => void;
}
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="border-none bg-transparent p-0 shadow-none">
        <button
          type="button"
          onClick={() => onOpenOverview("completed")}
