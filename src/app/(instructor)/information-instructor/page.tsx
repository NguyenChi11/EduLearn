...
import { UserDesktopSidebar } from "@/components/user/UserDesktopSidebar";
import { UserContent } from "@/components/user/UserContent";
import PublicProfileTab from "@/components/user/PublicProfileTab";
import ProfileTab from "@/components/user/ProfileTab";
import PhotoTab from "@/components/user/PhotoTab";
